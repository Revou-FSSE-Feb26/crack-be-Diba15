...
describe('ReportController', () => {
  ...
  let service: jest.Mocked<Partial<ReportService>>;
  ...
  describe('create', () => {
    it('should call reportService.create with correct params', async () => {
  ...
  describe('resolve', () => {
    it('should call reportService.resolve with curator id and dto', async () => {
